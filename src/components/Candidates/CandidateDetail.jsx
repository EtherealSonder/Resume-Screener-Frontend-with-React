...
function parseTags(raw) {
    ...
    // If it's not a string, force it to one
    if (typeof raw !== "string") raw = String(raw);

    try {
        // Handle PostgreSQL array string: {"item1","item2"}
            ...
            <div className="fixed inset-0 z-[1000] bg-black/60 backdrop-blur-sm flex items-center justify-center">
                <div className="relative bg-white w-full max-w-5xl max-h-[95vh] rounded-2xl shadow-2xl p-8 overflow-y-auto animate-fade-scale">
                    ...
                    <div className="mt-8 flex flex-wrap gap-4 justify-end">
                        ...
                        <button className="inline-flex items-center gap-2 bg-green-600 text-white px-5 py-3 rounded hover:bg-green-700 font-semibold text-sm">
                            <FaDownload />
                            Download Report
                        </button>
                    </div>
