...
export default function MostAppliedJobsTable({ data = [] }) {
    ...
    if (!data.length) {
        return <div className="text-gray-500 italic p-4">No job data available.</div>;
    }

    return (
        <div className="bg-white p-6 rounded-xl shadow text-black">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold">Most Applied Jobs</h2>
                <ExportButtons data={sortedData} fileName="MostAppliedJobs" />
            </div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div className="w-24 h-2 bg-gray-200 rounded">
                                            <div
                                                ...
                                                style={{
                                                    width: `${Math.round(
                                                        (job.application_count / maxApplications) * 100
                                                    )}%`,
                                                }}
                                            ></div>
                                        </div>
